...
<div class="container main" style="margin-top: 120px;">
    ...
    <div class="col-lg-offset-1 col-lg-12">
        <form action="#" id="cad-valor" method="post">
            ...
            <input type="hidden" id="codigo"  value="<?php echo $valor->getValorCodigo(); ?>"/>
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-6">
                <label for="valor">Valor</label>
                <input type="text" id="valor" name="valor" class="form-control" required="" value="<?php echo $valor->getValorValor(); ?>" />
            </div>
            <br>
            <br><br><br>
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-6">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-3">
                ...
                <input type="text" id="idade_inicial" name="idade_inicial" class="form-control" required="" value="<?php echo $valor->getIdadeInicial(); ?>"/>
            </div>
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-3">
                <label for="idade_final">Idade Final</label>
                <input type="text" id="idade_final" name="idade_final" class="form-control" required="" value="<?php echo $valor->getIdadeFinal(); ?>"/>
            </div>
