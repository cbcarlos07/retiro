        ...
        <form action="#" id="cad-pessoa" method="post">
            ...
            <div class="form-group col-lg-3 col-xs-12 col-sm-12 col-md-3">
                ...
                <select class="form-control" name="retiro" id="retiro">
                    ...
                    ?>
                           <option value="<?php echo $retiro->getCdRetiro(); ?>"><?php echo $retiro->getDsRetiro(); ?></option>
                    <?php
                       }
                    ?>
                </select>
            ...
            <div class  ="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
                ...
                <input name="cpf" id="cpf" value="${value}"  class="form-control" onblur="javascript: validarCPF(this.value);"
