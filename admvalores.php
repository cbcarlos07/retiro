...
$lista = $vc->getListaValores($nome);
$valorList = new ValoresListIterator($lista);
...
<div class="container main">
    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
        <a href="cadvalor.php" style="margin-top: 20px; float: right;" class="btn btn-primary novo" >Novo</a>
    </div>
    <div class="table table-hover table-responsive">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>
            <?php
             while($valorList->hasNextValores()){
                 $valor = $valorList->getNextValores();
             ?>
                 <tr>
                     <td><?php echo $valor->getValorCodigo();  ?></td>
                     <td><?php echo 'R$ '.number_format($valor->getValorValor(),2,',','.'); ?> </td>
                     <td><?php echo $valor->getDescricao(); ?></td>

                     <td class="actions">

                         <a class="btn btn-warning btn-xs action-button" href="#" data-nome="B" data-url="altvalor.php" data-id="<?php echo $valor->getValorCodigo();  ?>">Editar</a>
                         <a class="delete btn btn-danger btn-xs" href="#" data-toggle="modal" data-target="#delete-modal" data-nome="<?php echo 'R$: '.number_format($valor->getValorValor(),2); ?>" data-id="<?php echo $valor->getValorCodigo();  ?>">Excluir</a>
...
<script>
    $('.action-button').on('click', function(){
       ...
       // $('body').append(form);
        form.submit();
       // location.href = "valor?acao="+acao+"&codigo="+codigo;
