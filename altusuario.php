    ...
    <div class="col-lg-offset-1 col-lg-12">
        <form action="#" id="cad-usuario" method="post" data-toggle="validator">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-6">
                ...
                <input type="text" id="nome" name="nome" class="form-control" required="" placeholder="digite o nome" value="<?php echo $usuario->getNm_usuario(); ?>"/>
                <div class="help-block with-errors"></div>
            </div>
            <div class="row"></div>
            <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-3">
                <label for="login">Login</label>
                <input  id="login" name="login" class="form-control" required="" placeholder="digite o login" value="<?php echo $usuario->getDs_login(); ?>" disabled/>
                <div class="help-block with-errors"></div>
