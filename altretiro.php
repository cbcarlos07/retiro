...
<div class="container main" style="margin-top: 120px;">
    <div class=" col-lg-12">
        <form action="#" id="cad-retiro" method="post">
            ...
            <input type="hidden" id="codigo"  value="<?php echo $retiro->getCdRetiro(); ?>"/>
            <div class="form-group col-xs-12 col-sm-6 col-md-7 col-lg-6">
                <label for="descricao">Descri&ccedil;&atilde;o</label>
                <input type="text" id="descricao" name="descricao" class="form-control" required="" value="<?php echo $retiro->getDsRetiro(); ?>"/>
            </div>
            <div class  ="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
                ...
                <?php
                  ...
                  $data = $dia."/".$mes."/".$ano;
                ?>
                <input id="data" name="data"  type="text" class="form-control" required="" value="<?php echo $data; ?>"/>
            </div>
            <br>
            <br>
            <br>
